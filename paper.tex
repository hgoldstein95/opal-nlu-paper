...
We will define \ff{parse} by case analysis on the declaration.
\begin{align*}
...
Given a declaration $d$, we generate a configuration, \ff{cfg}. Then,
\begin{flalign*}
  &\forall\ (r : \textsf{Resp}).\\
...
value of the correct type. Thus, we only need to care that it is defined. Proof
of this fact is clear by induction on $d$.

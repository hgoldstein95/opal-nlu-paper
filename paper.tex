...
and $\langle {\ell} \rangle$ represents a disjunction of literals, and covers
the case of Keywords entities.
...
\begin{theorem}[\ff{parse} Correct]
  ...
  \begin{flalign*}
    &\forall\ (r : \textsf{Resp}).\\
    &r\ \text{well-formed}_{\ff{cfg}} \Rightarrow \ff{parse}(d, r)\ \text{defined}
  \end{flalign*}
\end{theorem}
\begin{proof}
  By induction on $d$.
...
intermediate representation mentioned in Figure \ref{fig:hs_ast}.

...
$\langle {\ell_1 \mid \dots \mid \ell_n} \rangle$, but since the NLU engine has
been configured with the same list of literals, we are guaranteed to get one of
them back from lookup (assuming lookup is defined).
\begin{align*}
